...
class _BottomStats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: const [
          _StatItem(label: 'Moves', value: '12', valueColor: Colors.white),
          _Divider(),
          _StatItem(label: 'Combo', value: 'x3', valueColor: Color(0xFF46E3FF)),
          _Divider(),
          _StatItem(label: 'Best', value: '1,850', valueColor: Color(0xFFF4C542)),
        ],
      ),
    );
  }
